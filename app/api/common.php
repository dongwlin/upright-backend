...
if (!function_exists('api_error')) {
     ...
     * @return Json
     */
    function api_error(string $msg = 'fail', array $data = [], int $code = 500): Json
    {
        return api_result($msg, $data, $code);
    }
}
...
if (!function_exists('api_service_unavailable')) {
     ...
     * @return Json
     */
    function api_service_unavailable(string $msg = 'service unavailable', array $data = [], int $code = 503): Json
    {
        return api_result($msg, $data, $code);
    }
}
...
if (!function_exists('api_error_client')) {
    /**
     * 客户端错误 例如提交表单的时候验证不通过，是因为客户端填写错误引起的
     * @param string $msg
     * @param array $data
     * @param int $code
     * @return Json
     */
    function api_error_client(string $msg = 'client error', array $data = [], int $code = 400): Json
    {
        return api_result($msg, $data, $code);
    }
}
...
if (!function_exists('api_error_server')) {
     ...
     * @return Json
     */
    function api_error_server(string $msg = 'server error', array $data = [], int $code = 500): Json
    {
        return api_result($msg, $data, $code);
    }
}
...
if (!function_exists('api_error_404')) {
     ...
     * @return Json
     */
    function api_error_404(string $msg = '404 not found', array $data = [], int $code = 404): Json
    {
        return api_result($msg, $data, $code);
    }
}